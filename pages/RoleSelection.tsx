  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 space-y-12 relative overflow-hidden">
       ...
       <div className="text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-light text-white tracking-[0.2em] uppercase border-b border-gray-700 pb-6 px-4">
            WELCOME TO DG SECRETARIAT
          </h1>
       </div>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl relative z-10">
          ...
          >
             ...
             <span className="text-xs text-gray-400 mt-2 font-medium">Read Only • No Controls</span>
          </button>
          ...
          >
             ...
             <span className="text-xs text-gray-400 mt-2 font-medium">Full Access • Settings</span>
          </button>
       </div>
    </div>
  );
